...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_FUN] = LAYOUT(
    XXXXX,         KC_F12,        KC_F11,        KC_F8,         KC_F9,         KC_PSCR,       XXXXX,         XXXXX,         XXXXX,         XXXXX,         XXXXX,         XXXXX,        \
    XXXXX,         KC_F7,         KC_F4,         KC_F5,         KC_F6,         KC_SCRL,       XXXXX,         KC_LSFT,       KC_LCTL,       KC_LALT,       KC_LGUI,       XXXXX,        \
